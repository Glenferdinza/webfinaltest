...
<body class="bg-gray-50 font-inter text-gray-900 overflow-x-hidden">
    <section id="edit-event" class="py-20 px-8 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto relative z-10">
            <div class="text-center mb-16 reveal">
                <span class="bg-gradient-to-r from-pink-500 to-violet-500 bg-clip-text text-transparent font-bold text-xl uppercase tracking-wider">Edit Event</span>
                <h2 class="font-bold text-5xl font-poppins text-gray-800 mt-4">Edit <span class="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Event</span></h2>
                <p class="text-gray-600 mt-4 text-lg">Update your event details</p>
            </div>
            ...
            <form method="POST" action="{{ route('events.update', $event->id) }}" enctype="multipart/form-data" class="glass-effect rounded-3xl p-8 shadow-2xl reveal">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="title" value="{{ old('title', $event->title) }}" class="w-full p-4 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all duration-300 hover:border-gray-300 text-gray-700 font-medium" 
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div id="dropzone" class="flex flex-col items-center justify-center w-full border-2 border-dashed border-gray-300 rounded-xl p-6 text-center transition-all duration-300 hover:border-blue-400 bg-white cursor-pointer"
                            ...
                            @if ($event->image)
                                <img id="preview" src="{{ asset('storage/' . $event->image) }}" alt="Event Image" class="mt-4 max-h-40 rounded-lg shadow" />
                            @else
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" class="w-full p-4 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all duration-300 hover:border-gray-300 text-gray-700 resize-none" 
                                rows="4" placeholder="Describe your event in detail..." required>{{ old('description', $event->description) }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="datetime-local" name="start_date" value="{{ old('start_date', \Carbon\Carbon::parse($event->start_date)->format('Y-m-d\TH:i')) }}" class="w-full p-4 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all duration-300 hover:border-gray-300 text-gray-700 font-medium" required>
                        @error('start_date')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="datetime-local" name="end_date" value="{{ old('end_date', \Carbon\Carbon::parse($event->end_date)->format('Y-m-d\TH:i')) }}" class="w-full p-4 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all duration-300 hover:border-gray-300 text-gray-700 font-medium" required>
                        @error('end_date')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="location" value="{{ old('location', $event->location) }}" class="w-full p-4 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all duration-300 hover:border-gray-300 text-gray-700 font-medium" 
                    ...
                    <div>
                        ...
                        <input type="text" name="organizer" value="{{ old('organizer', $event->organizer) }}" class="w-full p-4 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all duration-300 hover:border-gray-300 text-gray-700 font-medium" 
                    ...
                    <div>
                        ...
                        <input type="email" name="contact_email" value="{{ old('contact_email', $event->contact_email) }}" class="w-full p-4 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all duration-300 hover:border-gray-300 text-gray-700 font-medium" 
                    ...
                    <div>
                        ...
                        <input type="tel" name="contact_phone" value="{{ old('contact_phone', $event->contact_phone) }}" class="w-full p-4 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all duration-300 hover:border-gray-300 text-gray-700 font-medium" 
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="number" name="registration_fee" value="{{ old('registration_fee', $event->registration_fee ?? 0) }}" min="0" step="0.01" class="w-full p-4 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all duration-300 hover:border-gray-300 text-gray-700 font-medium" 
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="additional_info" class="w-full p-4 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all duration-300 hover:border-gray-300 text-gray-700 resize-none" 
                                rows="3" placeholder="Any additional information (optional)">{{ old('additional_info', $event->additional_info) }}</textarea>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select name="organizer_type" id="organizer_type" 
                                ...
                                <option value="student" {{ (old('organizer_type', $event->organizer_type) == 'student') ? 'selected' : '' }}>Student Organization</option>
                                <option value="faculty" {{ (old('organizer_type', $event->organizer_type) == 'faculty') ? 'selected' : '' }}>Faculty</option>
                                <option value="university" {{ (old('organizer_type', $event->organizer_type) == 'university') ? 'selected' : '' }}>University</option>
                                <option value="external" {{ (old('organizer_type', $event->organizer_type) == 'external') ? 'selected' : '' }}>External Partner</option>
                            </select>
                ...
                <button type="submit" class="block w-full mt-8 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold text-xl rounded-3xl py-5 hover:scale-105 transition-transform duration-300 shadow-lg">Update Event</button>
            </form>
        </div>
    </section>
