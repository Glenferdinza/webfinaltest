...
<head>
    ...
    <title>Reset Password - Portalis</title>
            ...
            <div class="w-full max-w-md">
                <div class="text-center mb-8 font-poppins glass-effect p-8 rounded-xl">
                    ...
                    <div class="alert alert-info mb-6">
                        ...
                        Reset link will be sent to: <strong>{{ auth()->user()->email }}</strong>
                    </div>
                    
                    <form id="resetPasswordForm" action="{{ route('password.forgot.logged.send') }}" method="POST" class="space-y-6 text-left">
                        @csrf
                        <div>
                            <label for="email" class="font-semibold mb-2 block text-gray-200">Confirm Email Address</label>
                            <input type="email" 
                                   name="email" 
                                   id="email" 
                    ...
                    <div class="mt-6 text-center space-y-3">
                        <p class="text-gray-300">
                            <a href="{{ route('profile') }}" class="text-blue-400 hover:text-blue-300 transition-colors duration-300 font-semibold">
                                Back to Profile
                            </a>
                        </p>
                    </div>
